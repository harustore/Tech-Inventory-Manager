    ...
    <div className="min-h-[100dvh] flex flex-col bg-slate-50">
      <header className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-white">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-slate-900 text-xl tracking-tight">TechStock</span>
        </div>
        <div className="flex gap-4">
          <Link href="/sign-in" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors flex items-center">
            Iniciar sesión
          </Link>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl text-left">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <h3 className="font-semibold text-slate-900 text-lg mb-2">Inventario Detallado</h3>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <h3 className="font-semibold text-slate-900 text-lg mb-2">Flujo de Caja</h3>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <h3 className="font-semibold text-slate-900 text-lg mb-2">Recomendaciones</h3>
